...
# modified from sharpy-sc2/tools/json_build.py

def calculate_race_and_build_str(filename: str):
    ...
    if race == Race.Protoss:
        ...
        raise Exception('Can\'t detect race: is there a worker unit in the build order?')
